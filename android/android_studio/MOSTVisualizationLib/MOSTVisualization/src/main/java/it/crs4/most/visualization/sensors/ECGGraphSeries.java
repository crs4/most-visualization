 ...
 * @author jjoe64
 */
public class ECGGraphSeries<E extends DataPointInterface> extends ECGSeries<E> {
     ...
     * wrapped styles
     */
    private it.crs4.most.visualization.sensors.ECGGraphSeries.Styles mStyles;
     ...
     */
    protected void init() {
        mStyles = new it.crs4.most.visualization.sensors.ECGGraphSeries.Styles();
        mPaint = new Paint();
